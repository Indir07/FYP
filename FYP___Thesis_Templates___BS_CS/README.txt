...
This is the SIBAU dissertation template for LaTeX. It is designed to work
with all versions of LaTeX, but if you want to adhere to the SIBAU house
...
Or by selecting the 'XeLaTeX' and 'Biber' options in your favorite TeX editing
program, respectively. This setup uses biblatex, so run biber on dissertation.
