...
\begin{axis}[
  ...
  % Keep legend inside the plotting area to avoid overlapping with captions/floats.
  legend style={at={(0.5,0.98)}, anchor=north, legend columns=3, draw=none, fill=white, fill opacity=0.75},
  grid=major, grid style={draw=gray!20},
  xmin=0, xmax=36,
  ymin=0, ymax=70,
]
\addplot[thick, sibau-sea-green!80!black, mark=none] coordinates {
  (0,0) (6,4) (12,9) (18,14) (24,20) (30,25) (36,28.7)
};
\addlegendentry{Rule-only}
\addplot[thick, sibau-orange!80!black, mark=none] coordinates {
  (0,0) (6,8) (12,18) (18,28) (24,38) (30,43) (36,47.3)
};
\addlegendentry{ML (no veto)}
\addplot[thick, sibau-purple!80!black, mark=none] coordinates {
  (0,0) (6,10) (12,24) (18,38) (24,50) (30,56) (36,61.2)
};
\addlegendentry{Full system}
\end{axis}
\end{tikzpicture}
\caption{Color-coded cumulative return comparison (illustrative trajectories aligned to terminal values in Table~\ref{ch5:tab1}).}
\label{ch5:fig1}
\end{figure}
...
\end{axis}
\end{tikzpicture}
\caption{Color-coded drawdown paths (illustrative; deeper negative values indicate larger peak-to-trough loss).}
\label{ch5:fig2}
\end{figure}
...
\draw[dashed, sibau-orange!90!black] (axis cs:16,-0.5) -- (axis cs:16,0.6);
\node[anchor=south west, sibau-orange!90!black] at (axis cs:17,0.35) {\footnotesize veto window};
\end{axis}
\end{tikzpicture}
\caption{Sentiment index during a volatile episode (purple line); the vertical marker indicates a sentiment veto window.}
\label{ch5:fig3}
\end{figure}
